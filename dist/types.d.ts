...
export type SDKMessage = SDKAssistantMessage | SDKToolResultMessage | SDKResultMessage | SDKPartialMessage | SDKSystemMessage | SDKCompactBoundaryMessage | SDKStatusMessage | SDKTaskNotificationMessage | SDKRateLimitEvent | SDKTextDeltaMessage;
...
export type CanUseToolFn = (tool: ToolDefinition, input: unknown) => Promise<CanUseToolResult>;
...
export interface AgentOptions {
    ...
    hooks?: Record<string, Array<{
        matcher?: string;
        hooks: Array<(input: any, toolUseId: string, context: {
            signal: AbortSignal;
        }) => Promise<any>>;
        timeout?: number;
    }>>;
