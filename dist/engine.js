...
import { withRetryStream, isPromptTooLongError, } from './utils/retry.js';
...
export class QueryEngine {
    ...
    async *submitMessage(prompt) {
        ...
        while (turnsRemaining > 0) {
            ...
            try {
                let finalResponse;
                for await (const event of withRetryStream(() => this.provider.createMessageStream(streamParams), undefined, this.config.abortSignal)) {
