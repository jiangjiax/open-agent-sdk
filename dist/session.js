 ...
 */
export async function saveSession(sessionId, messages, metadata) {
 ...
 */
export async function forkSession(sourceSessionId, newSessionId) {
 ...
 */
export async function appendToSession(sessionId, message) {
    const data = await loadSession(sessionId);
    if (!data)
        return;
